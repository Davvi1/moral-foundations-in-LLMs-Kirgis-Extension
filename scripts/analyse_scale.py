...
The two predictions were registered in state.md BEFORE any model above 14B was collected, each
...
def main() -> int:
    ...
    L.append("Both predictions were registered in `state.md` with pre-committed falsifiers, "
