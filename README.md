...
**31 models collected · 30 analysed · 6 scoring arms · 116 vignettes · 21,576 rows · 19 logged
corrections · 304 tests**
...
`docs/CORRECTIONS.md` logs **19 corrections** — every claim withdrawn or reversed, and how each
...
**Not one of the nineteen was found by looking at a result and feeling that it seemed wrong.**
...
pytest                      # 304 tests, ~2.5 min, no GPU needed
```
